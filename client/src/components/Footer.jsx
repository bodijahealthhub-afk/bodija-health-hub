...
export default function Footer() {
  const [tagline, setTagline] = useState('Care. Connected. Community.')
  const [copyright, setCopyright] = useState('© 2025 Bodija Health Hub. All rights reserved.')
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (data.footer_quick_links) {
            try { setQuickLinks(JSON.parse(data.footer_quick_links)) } catch {}
          }
          if (data.footer_platform_links) {
            try { setPlatformLinks(JSON.parse(data.footer_platform_links)) } catch {}
          }
          if (data.footer_social_links) {
            try { setSocialLinks(JSON.parse(data.footer_social_links)) } catch {}
          }
        }
      } catch {
        // Use defaults
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <img src="/BHH.png" alt="Bodija Health Hub" className="h-14 w-auto mb-4 brightness-0 invert" />
            <p className="text-gray-400 text-sm mb-4">{tagline}</p>
            <p className="text-gray-400 text-sm">Bodija, Ibadan, Oyo State, Nigeria</p>
          </div>
          ...
          {/* Social Media */}
          <div>
            <h3 className="text-sm font-semibold uppercase tracking-wider mb-4">Social Media</h3>
            <div className="flex gap-4">
              ...
              {socialLinks.twitter && socialLinks.twitter !== '#' && (
                <a href={socialLinks.twitter} className="text-gray-400 hover:text-white transition-colors" aria-label="X / Twitter" target="_blank" rel="noopener noreferrer">
              ...
              {socialLinks.linkedin && socialLinks.linkedin !== '#' && (
                <a href={socialLinks.linkedin} className="text-gray-400 hover:text-white transition-colors" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
              ...
              {socialLinks.whatsapp && socialLinks.whatsapp !== '#' && (
                <a href={socialLinks.whatsapp} className="text-gray-400 hover:text-white transition-colors" aria-label="WhatsApp" target="_blank" rel="noopener noreferrer">
